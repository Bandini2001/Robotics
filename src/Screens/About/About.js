      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12 text-center">
            <h2 className="section-title">THE TEAM BEHIND ROBOTICS</h2>
            ...
            <div className="team-item">
              ...
              <div className="team-info">
                ...
                <ul className="team-icon">
                  <li>
                    <a href="https://github.com/Bandini2001" className="github">
                      <i className="fa-fa-github"></i>
                    </a>
                  </li>
                  <li>
                    <a href="https://github.com/Bandini2001" className="gmail">
                  ...
                  <li>
                    <a
                      ...
                      className="linkdin"
                    >
                      <i className="fa-fa-likdin"></i>
                    </a>
                  </li>
                  <br></br>
                  <a href="https://github.com/Bandini2001">
                    <img src="./images/github.png" className="img" alt="git" />
                  </a>
                </ul>
              </div>
            </div>
            ...
            <div className="team-item">
              ...
              <div className="team-info">
                ...
                <ul className="team-icon">
                  ...
                  <br></br>
                  <a href="https://github.com/pushpakparkhe">
                    <img src="./images/github.png" className="img" alt="pic" />
                  </a>
                </ul>
              </div>
            </div>
            ...
            <div className="team-item">
              ...
              <div className="team-info">
                ...
                <ul className="team-icon">
                  ...
                  <br></br>
                  <a href="https://github.com/Sumesh99">
                    <img src="./images/github.png" className="img" alt="pic" />
                  </a>
                </ul>
              </div>
            ...
            <div className="team-item">
              ...
              <div className="team-info">
                ...
                <ul className="team-icon">
                  ...
                  <br></br>
                  <a href="https://github.com/bobadeganesh">
                    <img src="./images/github.png" className="img" alt="pic" />
                  </a>
                </ul>
              </div>
            ...
            <div className="team-item">
              ...
              <div className="team-info">
                ...
                <ul className="team-icon">
                  ...
                  <br></br>
                  <a href="https://github.com/payalm518">
                    <img src="./images/github.png" className="img" alt="pic" />
                  </a>
                </ul>
              </div>
            ...
            <div className="team-item">
              ...
              <div className="team-info">
                ...
                <ul className="team-icon">
                  ...
                  <br></br>
                  <a href="https://github.com/punamMGahane">
                    <img src="./images/github.png" className="img" alt="pic" />
                  </a>
                </ul>
              </div>
